...
set(GTEST_SOURCE_DIR  "${CMAKE_BINARY_DIR}/${GTEST_PROJECT}")
set(GTEST_BINARY_DIR  "${CMAKE_BINARY_DIR}/${GTEST_PROJECT}${BUILD_DIR_POSTFIX}")
set(GTEST_INSTALL_DIR "${CMAKE_BINARY_DIR}/${GTEST_PROJECT}${INSTALL_DIR_POSTFIX}")
set(GTEST_CONFIG_DIR  "${CMAKE_BINARY_DIR}/${GTEST_PORJECT}${CONFIGURATION_DIR_POSTFIX}")
...
IF(BUILD_TESTS)
    configure_file(
        ${CMAKE_CURRENT_LIST_DIR}/${GTEST_PROJECT}.txt.in
        ${GTEST_CONFIG_DIR}/CMakeLists.txt)
    
    InstallPackage(${GTEST_CONFIG_DIR})
